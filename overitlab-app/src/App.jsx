    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center px-4" style={{ background: "#0A0A0B" }}>
        ...
        <div className="text-center max-w-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
          <p className="text-sm font-semibold" style={{ color: "#F5C168" }}>No se pudo conectar con la base de datos.</p>
          <p className="text-xs mt-2" style={{ color: "#8A8A93" }}>
            Revisá que las variables VITE_SUPABASE_URL y VITE_SUPABASE_ANON_KEY estén bien cargadas en tu archivo .env.
          </p>
          <button
            onClick={loadOrders}
